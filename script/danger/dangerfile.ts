...
import { releaseNotesEntries, releaseNotesSection } from '../lib/release-notes';
...
const modifiedFixtures = danger.git.modified_files.filter((file) => FIXTURES_PATHS.some((fixturePath) => file.includes(fixturePath)));
