...
function darkModeToggle() {
	...
	function setTheme(theme, persist) {
		...
		if (themeToggleIcon) {
			themeToggleIcon.className = theme === 'dark' ? 'fa fa-sun-o' : 'fa fa-moon-o';
		}
	}
...
const copyPageActions = () => {
	...
	headerCopyMarkdownButton?.addEventListener('click', () => fetchAndCopyMarkdown(headerCopyMarkdownButton));
