...
Set
[`preview_tabs.enable_preview_from_project_panel`](./reference/all-settings.md#enable-preview-from-project-panel)
to `false` to open permanent tabs with a single click or {#action
project_panel::Open} ({#kb project_panel::Open}).
