...
Luau language support in Zed is provided by the community-maintained
...
[Luau Zed Extension README](https://github.com/4teapo/zed-luau).
...
Luau, or add to your settings file:
