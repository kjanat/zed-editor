...
- Language Server:
  [withastro/language-tools](https://github.com/withastro/astro/tree/main/packages/language-tools/language-server)
...
in Astro files, you need to configure the language server so that it knows about
...
With these settings, you will get completions for Tailwind CSS classes in Astro
