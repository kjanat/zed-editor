...
wish to disable the default language servers and enable Deno.

Configure language servers and formatters in Settings ({#kb zed::OpenSettings})
under Languages > JavaScript/TypeScript/TSX, or add to your settings file:
...
See [Configuring supported languages](../configuring-languages.md) in the Zed
...
To get completions for `deno.json` or `package.json`, add the following to your
settings file ([how to edit](../configuring-zed.md#settings-files)). For more
details, see [JSON](./json.md).
