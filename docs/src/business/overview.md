...
Zed Business is Zed for your team. Members with a paid Business seat get access
to Zed's hosted AI models and unlimited Edit Predictions. Administrators control
which AI features are available, what data leaves your environment, and how AI
spend is tracked.

It's for teams that want modern AI tooling without security trade-offs, and for
companies with procurement or compliance requirements that have blocked Zed
deployment.

## What's included

Every member gets access to all
[hosted AI models](../account/zed-hosted-models.md) and
[Edit Predictions](../ai/edit-prediction.md).
...
- **[Roles and permissions](../roles.md):** Owners, admins, Billing Managers,
  ...
  without counting toward paid Business seats or receiving Business subscription
  AI access.
- **Consolidated billing:** Your team's licenses and AI usage appear on
  [one invoice](../account/billing.md#organization), with no separate bills per
  member.
